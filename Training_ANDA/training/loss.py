...
class StyleGAN2Loss(Loss):
    def __init__(self, device, G_mapping, G_synthesis, D, diffaugment='', augment_pipe=None, style_mixing_prob=0.9, r1_gamma=10, pl_batch_shrink=2, pl_decay=0.01, pl_weight=2, with_dataaug=False, mou_epsilon=0.2):
        ...
        # Margin of Uncertainty: threshold used only for the Loss/signs/real_anda
    ...
    def adaptive_negative_augmentation(self, gen_img, pseudo_data):
        # Apply Adaptive Negative Data Augmentation (ANDA) to the generated images based on the
        # probability defined in the augment_pipe.p_anda. This is independent of ADA and is used 
        # to improve the discriminator's robustness. The pseudo_data is generated by applying a 
        # jigsaw transformation to the real images.
        ...
        if apply_anda:
            ...
            # Use a weighted combination of pseudo_data and gen_img to create the new augmented image
